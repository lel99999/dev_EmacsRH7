...
#      ansible.playbook = "deploy_emacsRH7.yml"
##     ansible.groups = {
...
##  Use Main / Update in Vagrant provision command ### $vagrant provision --provision-with shell/main/update
    ...
    # Default
    emacsRH7.vm.provision "main", type: "ansible" do |ansible|
      ansible.playbook = "deploy_emacsRH7_DEV.local.yml"
#     ansible.playbook = "deploy_emacsRH7_DEV.local.yml"
#     ansible.playbook = "deploy_emacsTestRH7.yml"
    ...
    # Update
#   emacsRH7.vm.provision "update", type: "ansible" do |ansible|
